...
<div class="section section-padding courses-detail">
    <div class="container">
        <div class="courses-detail-wrapper">
            <div class="row">
                <div class="col-md-9 layout-left"><h1 class="course-title">Get started with GATE 2018</h1>
                    ...
                    <div class="course-syllabus">
                        ...
                        <p>There will be 80 tests which will cover the entire syllabus.
                            ...
                            find the test series schedule <a href="gatexcel80.php#test-series">here</a></p>
                        ...
                        <div class="course-price-widget widget col-md-12 sd380">
                            ...
                            <div class="content-widget">
                                <div class="course-price-widget-wrapper">
                                    ...
                                    <div class="#"><p style="font-size: 22px;text-align: center;font-weight: bolder;">INR 30,000</p></div>
                                    <div class="row">
