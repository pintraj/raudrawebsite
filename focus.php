        ...
        <div class="courses-detail-wrapper remove-padding">
            <div class="row">
                <div class="col-md-12 layout-left"><h1 class="course-title">Call for the Soldiers (Focus Program)</h1>
                    ...
                    <div class="course-des">
                        ...
                        <div class="course-des-content">
                            <p>We are launching FOCUS BATCH 2018 for all those students who are excited to learn Applied
                                ...
                                consists of the following courses.</p>
                        ...
                        <div class="news-list">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-6">
                                    <p> The only prerequisite for this course is a working knowledge of a modern programming language like Java/C++/Python or an ability to read pseudocode. The candidates should carry a laptop when they come to the study space.
                    ...
                    <div class="underline">Selection Procedure</div>
                    <div class="selection-procedure">
                        <p>The candidates must fill the online application form in order to be considered for the selection process. Admissions to the course is subject to availability of seats. The selection for the programme will be subject to the satisfactory academic performance. The course is open for everyone. If the number of applicants is more than 300, then priority is as given below.
                        <ol>
                        ...
                        List of candidates who can apply for our course:
                        <ol type="a">
                        ...
                        The list of selected candidates will be released on 15 May, 2017 , tentatively.</p>
                    ...
                    <div class="course-syllabus">
                        ...
                        <div class="course-table">
                            <div class="outer-container custom-table-pos">
                    ...
                    <div class="course-des">
                        ...
                        <div class="question">
                            <ol>
                                ...
                                <p>Yes, it is a full time course and it is mandatory to stay.</p>
                                <li>How to apply for this program?
                                </li>
                                <p>Please fill this form.
                                </p>
                                <li>Is there any selection criteria?
                                </li>
                                <p>The course is open for everyone including the unregistered students. If the number of
                                    applicants is more than 300, then priority is as given below. <br>
                                <ol type="A">
                                    <li>Current GATE registered students</li>
                                    <li>Previous GATE registered students</li>
                                    <li>Current other course registered students</li>
                                ...
                                <p>No, we don’t provide any accommodation but there are hostels around our workplace.
                                </p>
                                ...
                                <p>The only prerequisite for this course is a working knowledge of a modern programming language like Java/C++/Python or an ability to read pseudocode. The course will begin on June-15th, 2017. The course would be over a 10 month period.
                                </p>
...
<div class="ml">
    <h1>TO UPGRADE YOUR CAREER</h1>
    <a href="https://docs.google.com/forms/d/e/1FAIpQLScRERhEUC4iveEVHAZVgm40omDTxMzHjYwc6SBa0RO0gCxXwg/viewform?c=0&w=1" target="_blank" class="btn btn-outline">Apply Now</a>


</div>
<div class="apply-now-fixed">
    <a href="https://docs.google.com/forms/d/e/1FAIpQLScRERhEUC4iveEVHAZVgm40omDTxMzHjYwc6SBa0RO0gCxXwg/viewform?c=0&w=1" target="_blank" class="btn btn-outline fixed-posi-apply hidden-sm hidden-xs">Apply
        <br> Now</a>
